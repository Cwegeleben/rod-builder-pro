...
export default function SpecTemplatesIndex() {
  // Local state only; replace with server persistence later
  const [templates, setTemplates] = useState<Template[]>([
    { id: 't1', name: 'Build Specs: Rods', fields: ['Length', 'Power', 'Action'] },
  ])
